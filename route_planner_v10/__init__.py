...
from route_planner_v10.util import file_name
from route_planner_v10.arguments import args
from route_planner_v10.version import __version__
from route_planner_v10.constants import LOGGING_LEVEL, LOGGING_PATH, LOGGING_FLAG

VERSION = __version__


print(f'Route Planner Module.. version: {VERSION}')
print('COPYRIGHT ⓒ 2024 HANYANG UNIVERSITY. ALL RIGHTS RESERVED.')
