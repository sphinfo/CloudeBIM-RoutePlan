...
# v1.3.0, 25.06.22 required True로 변경 (알고리즘 상에서 grader가 아닌 경우에도 사용하므로)
...
parser.add_argument('--Min_Fwdist', type=float, required=True, default=5.0, help='최소 전진 거리(상수 변경예정)')
